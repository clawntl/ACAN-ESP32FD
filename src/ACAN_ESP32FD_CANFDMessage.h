...
// ACAN_ESP32FD (this library) reuses the same class so it stays wire- and
// source-compatible with the rest of the ACAN family.
//------------------------------------------------------------------------------
...
//·············································································
  ...
  public: bool isValid (void) const {
    if ((type == CAN_REMOTE) || (type == CAN_DATA)) { // Remote or classic data frame
      return len <= 8 ;
    }else{ // CAN FD data frame
      return
